...
coord = read.table(file.path(paste0(currt_direct, '/data/', date_file, '/icao_coord.txt')), header = TRUE, sep = ",", dec = ".")
...
ggsave(paste0(currt_direct, '/plot_png/', date_file,"/first_test_bis.png"), 
       width = 15, height = 9) 
